...
export default function Board(props){
    ...
    const checkForWinner = () =>{
            if(clicked[0].clicked && clicked[0].player === clicked[1].player && clicked[1].player === clicked[2].player) props.endGame(activePlayer)
            else if(clicked[3].clicked && clicked[3].player === clicked[4].player && clicked[4].player === clicked[5].player) props.endGame(activePlayer)
            else if(clicked[6].clicked && clicked[6].player === clicked[7].player && clicked[7].player === clicked[8].player) props.endGame(activePlayer)
            else if(clicked[2].clicked && clicked[2].player === clicked[5].player && clicked[5].player === clicked[8].player) props.endGame(activePlayer)
            else if(clicked[1].clicked && clicked[1].player === clicked[4].player && clicked[4].player === clicked[7].player) props.endGame(activePlayer)
            else if(clicked[0].clicked && clicked[0].player === clicked[3].player && clicked[3].player === clicked[6].player) props.endGame(activePlayer)
            else if(clicked[2].clicked && clicked[2].player === clicked[4].player && clicked[4].player === clicked[6].player) props.endGame(activePlayer)
            else if(clicked[0].clicked && clicked[0].player === clicked[4].player && clicked[4].player === clicked[8].player) props.endGame(activePlayer)
            else if(totalMoves >= 9) props.endGame(null)
    }
